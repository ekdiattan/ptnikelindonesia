...
<div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
         <form action="/editbookingaccs/{{ $booking->id }}" method="post" enctype="multipart/form-data">
          <p class="card-description">Peminjaman Kendaraan</p>
                  @csrf
                  <div class="form-group row">
                    <div class="col-sm-6">
                      <label>Nama Kendaraan</label>
                      <input type="text" class="form-control" id="nama" name="nama_merk" value="{{ $booking->nama_merk }}">                      
                      </div>
                    <div class="col-sm-6">
